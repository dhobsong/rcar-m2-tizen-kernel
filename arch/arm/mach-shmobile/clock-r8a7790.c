...
enum {
	...
	MSTP115, MSTP109, MSTP103, MSTP102, MSTP101, MSTP100,
	MSTP112,
	MSTP000,
	MSTP_NR
};
...
static struct clk mstp_clks[MSTP_NR] = {
	...
	[MSTP131] = SH_CLK_MSTP32_STS(&zs_clk, SMSTPCR1, 31, MSTPSR1, 0), /* VSP1 (SY) */
	[MSTP130] = SH_CLK_MSTP32_STS(&zs_clk, SMSTPCR1, 30, MSTPSR1, 0), /* VSP1 (RT) */
